...
export const ParagraphRenderer = ({ paragraph, depth = 0, onClick }: ParagraphProps) => {
  return (
    <div className={depth > 0 ? `ml-${Math.min(depth * 6, 24)} mt-3 border-l-2 border-zinc-100 dark:border-zinc-800 pl-4` : "space-y-2"}>
      ...
      >
        {depth > 0 && <span className="text-zinc-300 dark:text-zinc-600 mt-1.5 leading-none shrink-0">↳</span>}
