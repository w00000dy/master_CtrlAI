...
export default function ImportPage() {
  ...
  const [processingState, setProcessingState] = useState<null | "extracting" | "structuring">(null);
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const structureResult = await structureTextWithLlm(extractedText, selectedModel);
