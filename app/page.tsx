				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
					...
					>
						...
						<div>
							...
							<p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
								Import and manage your source documents and policies.
							</p>
						</div>
					</Link>
					...
					>
						...
						<div>
							...
							<p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
								Extract and define compliance guidelines from documents.
							</p>
						</div>
					</Link>
					...
					>
						...
						<div>
							...
							<p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
								Generate and review specific security and compliance controls.
							</p>
						</div>
					</Link>
					...
					>
						...
						<div>
							...
							<p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
								Run automated tests to evaluate your compliance coverage.
							</p>
						</div>
					</Link>
				</div>
